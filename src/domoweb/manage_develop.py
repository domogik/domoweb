...
try:
    import settings_develop # Assumed to be in the same directory.
    settings = settings_develop    
except ImportError:
    import sys
    sys.stderr.write("Error: Can't find the file 'settings_develop.py' in the directory containing %r.\n" % __file__)
    sys.exit(1)
