...
Revision ID: 4c105cba179
Revises: None
Create Date: 2014-03-25 22:50:58.456646

"""

# revision identifiers, used by Alembic.
revision = '4c105cba179'
down_revision = None
...
def upgrade():
    ...
    sa.Column('type', sa.Unicode(length=50), nullable=True),
    sa.Column('version', sa.Unicode(length=50), nullable=True),
    ...
    sa.Column('id', sa.String(length=50), nullable=False),
    sa.Column('host', sa.Unicode(length=50), nullable=True),
    ...
    sa.Column('package_id', sa.String(length=50), nullable=False),
    sa.Column('device_type', sa.Unicode(length=50), nullable=False),
    ...
    sa.Column('name', sa.Unicode(length=50), nullable=True),
    sa.Column('device_id', sa.Integer(), nullable=False),
    sa.Column('reference', sa.Unicode(length=50), nullable=True),
    ...
    sa.Column('device_id', sa.Integer(), nullable=False),
    sa.Column('reference', sa.Unicode(length=50), nullable=True),
    sa.Column('datatype', sa.Unicode(length=50), nullable=True),
    sa.Column('last_value', sa.Unicode(length=50), nullable=True),
    sa.Column('last_received', sa.Unicode(length=50), nullable=True),
