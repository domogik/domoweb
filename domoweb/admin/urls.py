...
urlpatterns = patterns('domoweb.admin.views',
    ...
    url(r'client/(?P<client_id>[a-zA-Z0-9_.-]+)/$', 'admin_client', name="admin_client_view"),
    url(r'client/configure/(?P<client_id>[a-zA-Z0-9_.-]+)/$', 'admin_client_configure', name="admin_client_configure_view"),
    url(r'adddevice/(?P<client_id>[a-zA-Z0-9_.-]+)/(?P<type_id>[a-zA-Z0-9_.-]+)/$', 'admin_add_device', name="admin_add_device_view"),
